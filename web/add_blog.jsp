            ...
            <div id="site_content">		
                ...
                <div id="content">
                    <div class="content_item">
                        ...
                        <h2>New Article created successfully</h2>


                        <div id="content_bottom1">
                            <div class="content_bottom_container_boxl">
                                <div class="readmore1">
                                    <a href="BlogServlet?action=writeb"> Add More </a> </br>
                                </div><!--close readmore-->
                            </div><!--close content_bottom_container_box-->
                            <div class="content_bottom_container_boxl">
                                <div class="readmore1">
                                    <a href="BlogServlet?action=listBlog">View All</a></br>
                                </div><!--close readmore-->
                            </div><!--close content_bottom_container_box-->
                            <div class="content_bottom_container_boxl">
                                <div class="readmore1">
                                    <<a href="UserController?action=memlog"> Go to Profile</a>
                                </div><!--close readmore-->	  
