...
<body>
	...
	<div id="content">
        <div class="content_item">
		  <h2 text-align="center">Gallary</h2>
		  <!--<iframe scrolling="yes" marginheight="0" frameborder="0" width="451" style="height: 425px;" src="http://facebookgalleria.com/gallery.php?id=IUTPS&display=uploaded_photos&rows=4&margin=10&cols=3&width=140&font_size=11&title_color=000000&hide_next_back=0&share_buttons=1&shape=rectangle&frame=1"></iframe>-->
		  
		  <!--<iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FIUTPS%2Fposts%2F1021604484591820%3A0&width=500" width="500" height="646" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>-->
		  <iframe src="//embedsocial.com/facebook_album/album_photos/346307002121575" scrolling="yes" marginheight="0" frameborder="1" width="678" style="height: 425px;"></iframe>
