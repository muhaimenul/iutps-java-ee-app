            ...
            <div id="menubar">
                <nav class="menu">
                    <ul class="clearfix">
                        ...
                        <li class="current-item"><a href="BlogServlet?action=listBlog">Blog</a></li>
                        ...
                        <div class="list-scrol">
                            ...
                            <table>
                                ...
                                <c:forEach items="${blogs}" var="blog">
                                    ...
                                    <tr><h2><c:out value="${blog.title}" /></h2></tr>
                                <tr><h5><font size="4">By <c:out value="${blog.uId}" /></font></h5> </tr>
                            <tr><h6><c:out value="${blog.btime}" /></h6></tr>
                            <tr><p><c:out value="${blog.body}" /><p></tr>
                            <tr ><div align="center" style="border:2px solid black; background:#ccc; overflow:hidden;" >-----------------END------------------</div></tr>
                                        <br/><br/><br/><br/><br/>
                             </tr>
                                </c:forEach>
                                </table>
