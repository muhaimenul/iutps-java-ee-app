            ...
            <div id="menubar">
                <nav class="menu">
                    <ul class="clearfix">
                        ...
                        <li><a href="UserController?action=gal">Gallary</a></li>
                ...
                <div id="content">
                    <div class="content_item">
                        ...
                        <div class="form_settings">
                            ...
                            <p>&nbsp;</p>
                            <form method="POST" action="UserController"  name="frmUpdateUser">
                                <input type="hidden" name="update" value="frmUpdateUser"/>
                                ...
                                <p><span>Student ID : </span> <input class="contact" type="text" name="mem_id" value="<c:out value="${user.USER_ID}"/>" readonly="readonly"/></p>
                               ...
                               <p><span>Student ID : </span> <input class="contact" type="text" name="mem_id" value="<c:out value="${user.USER_ID}"/>" readonly="readonly"/></p>
                                ...
                                <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="action" value="update" /></p>
                            </form>
